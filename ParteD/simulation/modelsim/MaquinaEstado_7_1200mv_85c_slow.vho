...
-- Equation(s):
-- \fstate.state_bit_1~0_combout\ = (!\reset~input_o\ & (\x~input_o\ & ((\fstate.state_bit_1~q\) # (\fstate.state_bit_0~q\))))
...
-- Equation(s):
-- \fstate.state_bit_0~0_combout\ = (!\reset~input_o\ & (\x~input_o\ & ((\fstate.state_bit_1~q\) # (!\fstate.state_bit_0~q\))))
...
-- Equation(s):
-- \Z~1_combout\ = (\fstate.state_bit_0~q\ & (\fstate.state_bit_1~q\ & (!\reset~input_o\ & \x~input_o\)))
